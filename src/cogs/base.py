...
class Base(commands.Cog):
    ...
    async def cmd_help(self, ctx, *, cmdName: str = ""):
        ...
        e = discord.Embed(title="Cogs list (Not commands!)")
    ...
    async def cmd_settings(self, ctx: tools.dt.Context, entry: str = "", *, val: str = ""):
    ...
    async def cmd_settings(self, ctx: tools.dt.Context, *, stuff: str):
        pass
...
def setup(bot: discord.ext.commands.Bot):
    ...
    bot.cmd_help = types.MethodType(Base.cmd_help.__call__, bot)
